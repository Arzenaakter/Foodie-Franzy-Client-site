    ...
    <div className="px-6 lg:px-0">
      <div className="carousel w-full lg:h-[550px]  ">
        ...
        <div id="slide1" className=" carousel-item relative w-full  ">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center">
            ...
            <p className="lg:text-lg sm:text-sm">
              Try our mouth-watering burgers, made with the freshest ingredients
              and served on a wooden board.
            </p>
            <button className="bg-white text-black font-bold py-2 px-4 mt-4  rounded hover:bg-gray-200">
              Order now
            </button>
          </div>
        ...
        <div id="slide2" className="carousel-item relative w-full  ">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center">
            <h1 className=" font-bold mb-2 lg:text-3xl sm:text-xl">
              Delicious Chowmein
            </h1>
            <p className="lg:text-lg sm:text-sm">
              Taste the difference in our chow mein, crafted with love and care
              using traditional techniques and served hot for a satisfying and
        ...
        <div id="slide3" className="carousel-item relative w-full">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center">
            ...
            <p className="lg:text-lg sm:text-sm">
              Indulge in the rich and creamy flavors of our signature pasta
              dishes, made with the finest selection of fresh ingredients and
              served hot on your plate
            </p>
            <button className="bg-white text-black font-bold py-2 px-4 mt-4 rounded hover:bg-gray-200">
              Order now
            </button>
        ...
        <div id="slide4" className="carousel-item relative w-full">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center">
            ...
            <p className="lg:text-lg sm:text-sm">
              Try our mouth-watering homemade burgers, made with the freshest
              ingredients and served on a wooden board.
            </p>
            <button className="bg-white text-black font-bold py-2 px-4 mt-4 rounded hover:bg-gray-200">
              Order now
            </button>
